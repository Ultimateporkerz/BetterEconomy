...
public class ATMMenu extends AbstractContainerMenu {
    ...
    public ATMMenu(int containerId, Inventory playerInventory, FriendlyByteBuf buf) {
        this(containerId, playerInventory, playerInventory.player.getOnPos());
    }

    public ATMMenu(int containerId, Inventory playerInventory, BlockPos pos) {
    ...
    public int getDepositTotal() {
        ...
        for (int i = 0; i < playerInventory.items.size(); i++) {
            ...
            if (stack.getItem() instanceof CurrencyItem currencyItem) {
                total += currencyItem.getValue() * stack.getCount();
            }
        }
        return total;
    }
