...
public class ShopCustomerMenu extends AbstractContainerMenu {
    private final ShopBlockEntity blockEntity;
    private final Level level;

    public ShopCustomerMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public ShopCustomerMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.SHOP_CUSTOMER_MENU.get(), containerId);
    ...
    public BlockPos getShopBlockPos() {
